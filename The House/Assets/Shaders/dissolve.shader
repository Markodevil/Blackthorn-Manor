    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                clip(step((_noisetexture_var.rgb*_node_6640_var.rgb),_dissolveslider).r - 0.5);
////// Lighting:
////// Emissive:
