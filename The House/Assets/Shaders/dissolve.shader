    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float4 node_2678 = _Time;
                clip((step((_noisetexture_var.a*_node_6640_var.rgb),_dissolveslider)*(i.posWorld.rgb+float3((i.uv0+node_2678.g*float2(2,1)),0.0))).r - 0.5);
////// Lighting:
////// Emissive:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                float4 _noisetexture_var = tex2D(_noisetexture,TRANSFORM_TEX(i.uv0, _noisetexture));
                float4 _node_6640_var = tex2D(_node_6640,TRANSFORM_TEX(i.uv0, _node_6640));
                float4 node_1841 = _Time;
                clip((step((_noisetexture_var.a*_node_6640_var.rgb),_dissolveslider)*(i.posWorld.rgb+float3((i.uv0+node_1841.g*float2(2,1)),0.0))).r - 0.5);
