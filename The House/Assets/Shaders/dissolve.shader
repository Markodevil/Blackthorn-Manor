...
Shader "Shader Forge/dissolve" {
    Properties {
        ...
        _node_1269 ("node_1269", Range(0, 1)) = 0
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float4 node_9311 = _Time;
                float2 node_1509 = (i.uv0+node_9311.g*float2(0.5,0.5));
                float4 _node_6640_var = tex2D(_node_6640,TRANSFORM_TEX(node_1509, _node_6640));
                clip(step(lerp(_node_6640_var.rgb,float3(i.uv0,0.0),_node_1269),_dissolveslider).r - 0.5);
////// Lighting:
////// Emissive:
