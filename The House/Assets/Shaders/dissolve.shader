...
/*SF_DATA;ver:1.38;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,lico:1,lgpr:1,limd:1,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:3,bdst:7,dpts:2,wrdp:False,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:4013,x:33355,y:32710,varname:node_4013,prsc:2|emission-6991-OUT,alpha-2324-OUT,clip-5227-OUT;n:type:ShaderForge.SFN_Tex2d,id:3730,x:32245,y:33074,ptovrint:False,ptlb:noise texture,ptin:_noisetexture,varname:node_3730,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:5d7e00f1eebd0cb4695b5e24102d0a57,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Step,id:6282,x:32855,y:33172,varname:node_6282,prsc:2|A-9771-OUT,B-9797-OUT;n:type:ShaderForge.SFN_Slider,id:9797,x:32547,y:33552,ptovrint:False,ptlb:dissolve slider,ptin:_dissolveslider,varname:node_9797,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:1;n:type:ShaderForge.SFN_ComponentMask,id:5227,x:33081,y:33172,varname:node_5227,prsc:2,cc1:0,cc2:-1,cc3:-1,cc4:-1|IN-6282-OUT;n:type:ShaderForge.SFN_Tex2d,id:1467,x:31526,y:32439,ptovrint:True,ptlb:Base Color_copy,ptin:_MainTex,varname:_MainTex,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:28c7aad1372ff114b90d330f8a2dd938,ntxv:1,isnm:False;n:type:ShaderForge.SFN_Multiply,id:6991,x:33016,y:32690,varname:node_6991,prsc:2|A-3405-OUT,B-2324-OUT;n:type:ShaderForge.SFN_Add,id:3405,x:32779,y:32442,varname:node_3405,prsc:2|A-5982-OUT,B-7159-OUT;n:type:ShaderForge.SFN_Add,id:2324,x:32788,y:32754,varname:node_2324,prsc:2|A-7159-OUT,B-3732-OUT;n:type:ShaderForge.SFN_Vector1,id:659,x:32474,y:32365,varname:node_659,prsc:2,v1:1.5;n:type:ShaderForge.SFN_Multiply,id:4877,x:32233,y:32536,varname:node_4877,prsc:2|A-2210-OUT,B-3399-OUT;n:type:ShaderForge.SFN_Multiply,id:2210,x:31985,y:32536,varname:node_2210,prsc:2|A-656-RGB,B-7487-OUT;n:type:ShaderForge.SFN_Color,id:656,x:31985,y:32353,ptovrint:False,ptlb:node_8037_copy,ptin:_node_8037_copy,varname:_node_8037_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.3,c2:0.8,c3:0.9,c4:1;n:type:ShaderForge.SFN_Desaturate,id:7487,x:31758,y:32552,varname:node_7487,prsc:2|COL-1467-RGB,DES-6570-OUT;n:type:ShaderForge.SFN_Slider,id:6570,x:31423,y:32669,ptovrint:False,ptlb:amount_copy,ptin:_amount_copy,varname:_amount_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.2665723,max:1;n:type:ShaderForge.SFN_Lerp,id:3399,x:31985,y:32781,varname:node_3399,prsc:2|A-4643-OUT,B-6498-OUT,T-6003-OUT;n:type:ShaderForge.SFN_Vector1,id:4643,x:31966,y:32701,varname:node_4643,prsc:2,v1:1;n:type:ShaderForge.SFN_Multiply,id:6498,x:31705,y:32808,varname:node_6498,prsc:2|A-2346-OUT,B-6003-OUT;n:type:ShaderForge.SFN_Vector1,id:6003,x:31705,y:32973,varname:node_6003,prsc:2,v1:2;n:type:ShaderForge.SFN_RemapRange,id:2346,x:31471,y:32808,varname:node_2346,prsc:2,frmn:0,frmx:1,tomn:0.5,tomx:1|IN-5457-OUT;n:type:ShaderForge.SFN_Noise,id:1547,x:31080,y:32827,varname:node_1547,prsc:2|XY-9350-OUT;n:type:ShaderForge.SFN_Multiply,id:9350,x:30920,y:32827,varname:node_9350,prsc:2|A-4420-UVOUT,B-1996-TSL;n:type:ShaderForge.SFN_Slider,id:3732,x:32710,y:32947,ptovrint:False,ptlb:Opacity_copy,ptin:_Opacity_copy,varname:_Opacity_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.8063589,max:1;n:type:ShaderForge.SFN_Multiply,id:7159,x:32566,y:32700,varname:node_7159,prsc:2|A-2417-OUT,B-3447-OUT;n:type:ShaderForge.SFN_Multiply,id:5982,x:32515,y:32440,varname:node_5982,prsc:2|A-659-OUT,B-4877-OUT;n:type:ShaderForge.SFN_Slider,id:3447,x:32350,y:32904,ptovrint:False,ptlb:scanline opacity_copy,ptin:_scanlineopacity_copy,varname:_scanlineopacity_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0,max:1;n:type:ShaderForge.SFN_Power,id:2417,x:32350,y:32700,varname:node_2417,prsc:2|VAL-8343-OUT,EXP-397-OUT;n:type:ShaderForge.SFN_Frac,id:8343,x:31999,y:32938,varname:node_8343,prsc:2|IN-5031-OUT;n:type:ShaderForge.SFN_Vector1,id:397,x:32157,y:32972,varname:node_397,prsc:2,v1:10;n:type:ShaderForge.SFN_OneMinus,id:9824,x:31772,y:33210,varname:node_9824,prsc:2|IN-7716-OUT;n:type:ShaderForge.SFN_Add,id:7716,x:31595,y:33210,varname:node_7716,prsc:2|A-3026-OUT,B-6758-OUT;n:type:ShaderForge.SFN_Multiply,id:3026,x:31397,y:33210,varname:node_3026,prsc:2|A-3339-OUT,B-6738-OUT;n:type:ShaderForge.SFN_FragmentPosition,id:543,x:30980,y:33088,varname:node_543,prsc:2;n:type:ShaderForge.SFN_Append,id:6738,x:31180,y:33324,varname:node_6738,prsc:2|A-7218-OUT,B-9272-OUT;n:type:ShaderForge.SFN_Vector1,id:7218,x:30993,y:33277,varname:node_7218,prsc:2,v1:1;n:type:ShaderForge.SFN_Vector1,id:9272,x:30993,y:33384,cmnt:canLine,varname:node_9272,prsc:2,v1:0.8;n:type:ShaderForge.SFN_Append,id:2989,x:31180,y:33546,varname:node_2989,prsc:2|A-7015-OUT,B-2113-OUT;n:type:ShaderForge.SFN_Vector1,id:7015,x:31013,y:33546,varname:node_7015,prsc:2,v1:0;n:type:ShaderForge.SFN_Vector1,id:2113,x:31013,y:33623,varname:node_2113,prsc:2,v1:3;n:type:ShaderForge.SFN_Append,id:3339,x:31180,y:33107,varname:node_3339,prsc:2|A-543-X,B-543-Y;n:type:ShaderForge.SFN_ComponentMask,id:5031,x:31965,y:33210,varname:node_5031,prsc:2,cc1:1,cc2:-1,cc3:-1,cc4:-1|IN-9824-OUT;n:type:ShaderForge.SFN_ScreenPos,id:4420,x:30735,y:32727,varname:node_4420,prsc:2,sctp:0;n:type:ShaderForge.SFN_Time,id:1996,x:30735,y:32888,varname:node_1996,prsc:2;n:type:ShaderForge.SFN_Time,id:518,x:31062,y:33712,varname:node_518,prsc:2;n:type:ShaderForge.SFN_Multiply,id:6758,x:31384,y:33593,varname:node_6758,prsc:2|A-2989-OUT,B-7239-OUT;n:type:ShaderForge.SFN_Multiply,id:5457,x:31286,y:32808,varname:node_5457,prsc:2|A-1547-OUT,B-1648-OUT;n:type:ShaderForge.SFN_Vector1,id:1648,x:31250,y:32975,varname:node_1648,prsc:2,v1:4;n:type:ShaderForge.SFN_Divide,id:7239,x:31267,y:33807,varname:node_7239,prsc:2|A-518-T,B-546-OUT;n:type:ShaderForge.SFN_Slider,id:546,x:30926,y:33905,ptovrint:False,ptlb:node_546,ptin:_node_546,varname:node_546,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:3.871927,max:100;n:type:ShaderForge.SFN_Multiply,id:9771,x:32578,y:33124,varname:node_9771,prsc:2|A-3730-RGB,B-8619-OUT;n:type:ShaderForge.SFN_Tex2d,id:6640,x:32235,y:33272,ptovrint:False,ptlb:node_6640,ptin:_node_6640,varname:node_6640,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:28c7aad1372ff114b90d330f8a2dd938,ntxv:0,isnm:False;n:type:ShaderForge.SFN_TexCoord,id:6929,x:31493,y:33872,varname:node_6929,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_Code,id:8619,x:31744,y:33467,varname:node_8619,prsc:2,code:,output:0,fname:Function_node_8619,width:681,height:208,input:1,input_1_label:UV|A-7845-OUT;n:type:ShaderForge.SFN_Vector1,id:8743,x:31678,y:33265,varname:node_8743,prsc:2,v1:0;n:type:ShaderForge.SFN_Vector1,id:4502,x:31849,y:34128,varname:node_4502,prsc:2,v1:2;n:type:ShaderForge.SFN_Panner,id:8839,x:31714,y:33872,varname:node_8839,prsc:2,spu:0.05,spv:0.065|UVIN-6929-UVOUT;n:type:ShaderForge.SFN_Multiply,id:7845,x:32035,y:33892,varname:node_7845,prsc:2|A-8839-UVOUT,B-4502-OUT;proporder:3730-9797-1467-656-6570-3732-3447-546-6640;pass:END;sub:END;*/
...
Shader "Shader Forge/dissolve" {
    ...
    SubShader {
        ...
        Pass {
            ...
            float Function_node_8619( float2 UV ){
            float2 p = floor(UV);
              float2 f = frac(UV);
              f = f * f * (3.0 - 2.0 * f);
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                clip(step((_noisetexture_var.rgb*Function_node_8619( ((i.uv0+node_7397.g*float2(0.05,0.065))*2.0) )),_dissolveslider).r - 0.5);
////// Lighting:
////// Emissive:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                clip(step((_noisetexture_var.rgb*Function_node_8619( ((i.uv0+node_4141.g*float2(0.05,0.065))*2.0) )),_dissolveslider).r - 0.5);
